...
const IssueDetail = () => {
  ...
  if (error || !issue) {
    return <div className="app-container" style={{ padding: "var(--space-12) var(--space-4)" }}>
      ...
      action={<Link to="/" className="btn btn-primary">
              <ArrowLeft size={16} />
  ...
  return <div className="app-container" style={{ padding: "var(--space-6) var(--space-4)", maxWidth: "1000px" }}>
      {
  ...
  />
        ...
        {issue.summary && <p style={{ fontSize: "1.0625rem", color: "var(--text-secondary)", marginBottom: "var(--space-4)", lineHeight: 1.6 }}>
            {issue.summary}
          </p>}
  ...
  >
          ...
          {issue.assignee && <div style={{ display: "flex", alignItems: "center", gap: "6px", color: "var(--accent-primary)", fontWeight: 600 }}>
              <User size={16} />
    ...
    /* Status Lifecycle Timeline */
        ...
        <div className="card" style={{ padding: "var(--space-6)" }}>
          ...
          {history.length === 0 ? <p style={{ fontSize: "0.875rem", color: "var(--text-tertiary)" }}>
              No status updates recorded yet.
            </p> : <div style={{ position: "relative", paddingInlineStart: "24px" }}>
              <div
    style={{
      position: "absolute",
      top: "8px",
  ...
  />
              {history.map((h, idx) => <div key={h.id || idx} style={{ position: "relative", marginBottom: "var(--space-4)" }}>
                  <div
    style={{
      position: "absolute",
      top: "4px",
  ...
  />
                  ...
                  {h.note && <p style={{ fontSize: "0.875rem", color: "var(--text-secondary)", marginTop: "4px" }}>
                      {h.note}
                    </p>}
                  {h.changed_by && <div style={{ fontSize: "0.75rem", color: "var(--text-tertiary)", marginTop: "2px" }}>
  ...
  >
          ...
          {reports.length === 0 ? <p style={{ fontSize: "0.875rem", color: "var(--text-tertiary)" }}>
              {t("issue.noReports")}
  ...
  >
    ...
    placeholder={user ? t("issue.addCommentPlaceholder") : "Sign in to join the discussion and post updates..."}
    onClick={() => {
  ...
  >
    ...
    /* Comments List */
          ...
          {isCommentsLoading ? <div style={{ textAlign: "center", padding: "var(--space-4)" }}>
  ...
  >
              {t("issue.noComments")}
            </div> : <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
    ...
    return <div
      ...
      style={{
        padding: "var(--space-4)",
        borderRadius: "var(--radius-md)",
        backgroundColor: isOfficial ? "var(--accent-subtle)" : "var(--bg-surface-subtle)",
        border: isOfficial ? "1px solid var(--accent-primary)" : "1px solid var(--border-default)",
        display: "flex",
        flexDirection: "column",
        gap: "6px"
      }}
