...
const ReportWizard = () => {
  ...
  const submitMutation = useMutation({
    mutationFn: async () => {
      ...
      if (selectedImageFile) {
        finalImageUrl = await uploadFreeImage(selectedImageFile, imagePreview || void 0);
      ...
      return api.createReport({
        ...
        longitude,
        title: title || void 0,
        image_url: finalImageUrl || void 0
      });
    },
    onSuccess: (data) => {
  ...
  return <div className="app-container" style={{ padding: "var(--space-6) var(--space-4)", maxWidth: "720px" }}>
      {
    /* Header */
  }
  ...
  >
    ...
    >
      ...
      style={{
        ...
        fontSize: "0.875rem",
        fontWeight: 600,
        backgroundColor: isCurrent || isCompleted ? "var(--accent-primary)" : "var(--bg-surface-subtle)",
  ...
  />
    ...
    /* STEP 2: CATEGORY & DESCRIPTION */
        ...
        {currentStep === 2 && <div className="animate-fade-in" style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
  ...
  />
    ...
    /* STEP 3: OPTIONAL PHOTO */
        ...
        {currentStep === 3 && <div className="animate-fade-in" style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
  ...
  >
    ...
    style={{
      ...
      textAlign: "center",
      backgroundColor: isDragging ? "var(--accent-subtle)" : "var(--bg-surface-subtle)",
      position: "relative",
      cursor: "pointer",
      transition: "all var(--transition-fast)"
    }}
  ...
  />
                  {isCompressingImage ? <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
  ...
  />
    ...
    /* STEP 4: REVIEW */
        ...
        {currentStep === 4 && <div className="animate-fade-in" style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
            <h3 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "4px", display: "flex", alignItems: "center", gap: "8px" }}>
  ...
  >
              ...
              {(imagePreview || imageUrl) && <div style={{ display: "flex", alignItems: "center", gap: "12px", marginTop: "4px" }}>
  ...
  >
    ...
    /* STEP 5: SUCCESS CONFIRMATION & HAVERSINE RESULT */
        ...
        {currentStep === 5 && submissionResult && <div className="animate-fade-in" style={{ textAlign: "center", padding: "var(--space-6) 0" }}>
            <div
    style={{
      width: "64px",
      height: "64px",
  ...
  >
    ...
    /* Distinct feedback for deduplicated match vs new issue */
            ...
            {submissionResult.is_new_issue ? <p
    style={{
      fontSize: "0.9375rem",
