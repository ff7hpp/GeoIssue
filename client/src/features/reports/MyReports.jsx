...
const MyReports = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, description }) => api.updateReport(id, { description }),
    onSuccess: () => {
  ...
  >
    ...
    action={<Link to="/reports/new" className="btn btn-primary">
              <PlusCircle size={16} />
  ...
  /> : <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
    ...
    >
      ...
      /* Citizen Report Description / Editing */
                ...
                {isEditing ? <div style={{ marginTop: "8px", marginBottom: "12px" }}>
                    <textarea
      rows={3}
