...
const AppHeader = () => {
  ...
  return <>
      {role === "admin" && isAdminRoute && <div style={{ backgroundColor: "var(--status-resolved)", color: "white", padding: "4px 16px", fontSize: "0.75rem", fontWeight: 600, textAlign: "center", letterSpacing: "0.05em" }}>
  ...
  >
    ...
    /* User Profile / Auth Action */
            ...
            {user ? <div className="header-user-controls" style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                <div
    style={{
      display: "flex",
      alignItems: "center",
